    ...
    <>
      <div className="troubleshoot-modal-overlay">
        <div className="troubleshoot-modal-content">
          <button className="troubleshoot-close-button" onClick={onClose}>×</button>
          ...
          <form onSubmit={handleSubmit} className="troubleshoot-form">
            ...
            <div className="troubleshoot-form-group">
              ...
              <input type="text" name="serviceCode" value={formData.serviceCode} onChange={handleInputChange} required />
            </div>

            <div className="troubleshoot-form-group">
              <label>Last Serviceman (optional):</label>
              <input type="text" name="lastServiceman" value={formData.lastServiceman} onChange={handleInputChange} />
            </div>
            ...
            <div className="troubleshoot-form-row">
              <div className="troubleshoot-form-group">
                ...
                <textarea name="description" value={formData.description} onChange={handleInputChange} required className="troubleshoot-textarea" />
              </div>
            ...
            <button type="submit" className="troubleshoot-button">Submit</button>
          </form>
        </div>
      </div>
